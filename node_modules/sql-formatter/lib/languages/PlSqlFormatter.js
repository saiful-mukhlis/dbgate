...
var PlSqlFormatter = /*#__PURE__*/function (_Formatter) {
  ...
  _createClass(PlSqlFormatter, [{
    ...
    value: function tokenOverride(token) {
      if (token.type === _tokenTypes["default"].RESERVED_TOP_LEVEL && token.value.toUpperCase() === 'SET' && this.previousReservedToken.value.toUpperCase() === 'BY') {
...
_defineProperty(PlSqlFormatter, "tokenizer", new _Tokenizer["default"]({
