...
class MySqlClient {
    ...
    getTableColumns({ schema, table }) {
        return __awaiter(this, void 0, void 0, function* () {
            const { rows } = yield this.raw(`SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = '${schema}' AND TABLE_NAME='${table}'`);
            const { rows: fields } = yield this.raw(`SHOW CREATE TABLE \`${schema}\`.\`${table}\``);
